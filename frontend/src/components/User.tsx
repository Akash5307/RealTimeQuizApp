...
export const User = () => {
    ...
    const [submitted, setSubmitted] = useState(false); // Change to true or handle initial state differently
            ...
            <div>
                <div className="bg-blue-50 flex items-center justify-center h-screen">
                    <div className="text-center">
                        ...
                        <div className="mb-8">
                            <input
                                className="text-center w-64 p-2 border-2 border-blue-600 rounded-lg shadow-sm focus:outline-none focus:border-green-400"
                        ...
                        <button
                            className="bg-blue-500 text-white w-64 py-2 rounded-lg shadow-md hover:bg-green-400 focus:outline-none focus:ring-2 focus:ring-blue-800 focus:ring-opacity-50"
                            style={{ fontSize: "1rem" }}
                            onClick={() => {
                                setSubmitted(true);
                            }}
